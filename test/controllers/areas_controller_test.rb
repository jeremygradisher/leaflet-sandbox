...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { coords: @area.coords, info: @area.info, name: @area.name, status: @area.status }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { coords: @area.coords, info: @area.info, name: @area.name, status: @area.status }
    assert_redirected_to area_path(assigns(:area))
  end
